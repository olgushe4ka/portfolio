    ...
    <header className={`${headerStyles.header} pl-15 pr-15 pb-0 pt-0`}>
      <div className={`${headerStyles.boxLeft}`}>
        <Link to="/" className={`${headerStyles.konstructor}`}>
          ...
          <p className="text text_type_main-small">Главная</p>
        </Link>
        <Link to="/feed" className={`${headerStyles.lentaZakazov}`}>
          <div className={`${headerStyles.icon} ml-8 mr-2 mb-0 mt-0`}>
            <ListIcon type="primary" />
          </div>
          <p className="mr-33 text text_type_main-small ">О нас</p>
        </Link>
        <Link to="/feed" className={`${headerStyles.lentaZakazov}`}>
          <div className={`${headerStyles.icon} mr-2 `}>
            <ListIcon type="primary" />
          </div>
          <p className="text text_type_main-small">Портфолио</p>
        </Link>
        <Link to="/feed" className={`${headerStyles.lentaZakazov}`}>
          <div className={`${headerStyles.icon} mr-2 `}>
            <ListIcon type="primary" />
          </div>
          <p className="text text_type_main-small">Услуги и цены</p>
        </Link>
        <Link to="/feed" className={`${headerStyles.lentaZakazov}`}>
          <div className={`${headerStyles.icon} mr-2 `}>
            <BurgerIcon type="primary" />
          </div>
          <p className="text text_type_main-small">Контакты</p>
        </Link>
      </div>
