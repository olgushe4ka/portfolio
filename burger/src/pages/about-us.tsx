  ...
  return (
    <div className={styles.aboutus}>
      <div className={styles.aboutusImg}>
        <img src={require("../images/we.jpg")} width="100%" height="auto" />
      </div>{" "}
      <div>
        ...
        <p className={`${styles.aboutusText}`}>
          ...
          нас схожие вкусы и взгляды, мы очень много спорим по каждому узлу, но
          именно в этих спорах и рождается истина - то самое верное и правильное
          решение! Мы обожаем свою работу!
        </p>{" "}
      </div>
    </div>
  );
