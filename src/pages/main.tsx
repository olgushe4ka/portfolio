    ...
    <div className={styles.app}>
      <div className={`${styles.main}`}>
        ...
        <p className={`${styles.aboutusText}`}>
          КАКОЙ_ТО ТЕКСТ <br /> <br />Мы - Лейсан, Юля и Айгуль - именно эти лица стоят за
          ...
          Также в нашей команде визуализатор и специалист по чертежам -
          незаменимая часть нашей творческой семьи. Кто -то мечтал об этой
          профессии с самого детства, а кто-то прошел через свой ремонт, и
          понял, что больше без запаха штукатурки и постоянных творческих
          мозговых штурмов жить не может. <br /> <br />
